...
// GDT entries
#define NR_SEGMENTS      MAX_PCB_NUM*2+5           // GDT size
#define SEG_KCODE   1           // Kernel code
#define SEG_KDATA   2           // Kernel data/stack
//#define SEG_UCODE   2           // User code
//#define SEG_UDATA   4           // User data/stack
#define SEG_TSS     3           // Global unique task state segement
#define SEG_VIDEO   4
...
#define SEG_UCODE(i) (i*2+5)
#define SEG_UDATA(i) (i*2+6)
