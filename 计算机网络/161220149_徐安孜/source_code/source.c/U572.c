...
char mac_addr1[6]={0x00,0x0c,0x29,0xa8,0x64,0xcb};
char mac_addr2[6]={0x00,0x0c,0x29,0xbf,0xc2,0x0b };
...
void initDevice(){
	...
	device[0].ip_addr[0]=192; device[0].ip_addr[1]=168; device[0].ip_addr[2]=2; device[0].ip_addr[3]=2;

	device[1].index=1;
	get_mac_addr(device[1].mac_addr,1);
	
	device[1].ip_addr[0]=192; device[1].ip_addr[1]=168; device[1].ip_addr[2]=3; device[1].ip_addr[3]=1;
}
...
void initRouteInfo(){
	...
	route_info[0].interface=3;
	memcpy(route_info[0].mac_addr,mac_addr2,6);

	route_info[1].destination[0]=192;
	route_info[1].destination[1]=168;
	route_info[1].destination[2]=2;
	route_info[1].destination[3]=0;


	route_info[1].gateway[0]=192;
	route_info[1].gateway[1]=168;
	route_info[1].gateway[2]=2;
	route_info[1].gateway[3]=1;
	...
	memcpy(route_info[1].mac_addr,mac_addr1,6);
	route_info[1].interface=2;
